...
const Products = ({ productPromise }) => {
    ...
    return (
        <>
            ...
            <div >
                {
                    btnType === "product" ? <Product products={products} selectedProduct={selectedProduct} setSelectedProduct={setSelectedProduct} totalPrice={totalPrice} setTotalPrice={setTotalPrice}></Product> : <Cart totalPrice={totalPrice} setTotalPrice={setTotalPrice} selectedProduct={selectedProduct} setSelectedProduct={setSelectedProduct}></Cart>
                }
            </div>
        </>
    );
